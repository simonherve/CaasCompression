...
class CompressPDF:
    def __init__(self, input_file_path):
        ...
        self.output_file_path = self.create_output_file_path(input_file_path)

    def process_pdf(self):
        try:
            file = open(f"../input/{self.input_file_path}", "rb")
            ...
            output_file_path = self.create_output_file_path(self.input_file_path)
    ...
    def create_output_file_path(input_file_path) -> str:
        ...
        return f"../output/{input_file_path}_compressed.pdf"
...
def get_list_pdf_file():
    # List the pdf files in the input folder
    # Return the list as an array
    return [_ for _ in os.listdir("../input") if _.endswith(".pdf")]

if __name__ == "__main__":
    init_env_var()
    #for _ in tqdm(get_list_pdf_file()):
    _ = "BrochureCACreditEuro(Mars2024)sansvisuel.pdf"
    compressor = CompressPDF(_)
    compressor.process_pdf()
